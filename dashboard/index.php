    ...
    <div class="container-fluid mt-3">
                ...
                <div class="card gradient-1">
                    <div class="card-body">
                        ...
                        <div class="d-inline-block">
                            <h2 class="text-white"><?php echo count($resultpresentarray['data']); ?></h2>
                        </div>
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xxl-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Requests for Approval (<?php echo count($resultpendingrequestarray['data']); ?>)
                        </h4>
                        <hr class="style3">
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xxl-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Upcomming Leave Person (<?php echo count($resultleavearray['data']); ?>)
                        </h4>
                        <hr class="style3">
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xxl-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Absent Today (<?php echo count($resultabsenarray['data']); ?>)   
                        </h4>
                        <hr class="style3">
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xxl-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Birthday In This Month (<?php echo count($resultbirthArray['data']); ?>) <i class="fa fa-birthday-cake"
                                aria-hidden="true"></i>
                        </h4>
                        <hr class="style3">
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xxl-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Present Employee (<?php echo count($resultpresentarray['data']); ?>)
                        </h4>
                        <hr class="style3">
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xxl-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Upcoming Holiday (<?php echo count($resultArray['data']); ?>)
                        </h4>
                        <hr class="style3">
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xxl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3 class="card-title">Work Anniversary This Month (<?php echo count($resultanniversaryArray['data']); ?>)
                        </h3>
                        <hr class="style3">
...
<!-- <script> 
        $(document).ready(function(){ 
            ...
            var chart = new CanvasJS.Chart("flotPie1", { 
                    data: [{ 
                        type: "pie", 
