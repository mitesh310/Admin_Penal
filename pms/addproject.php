                    ...
                    <form class="row g-3 ml-4 mr-4 " method="post" id="project_form" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4 mt-2">
                            ...
                            <textarea class="form-control"
                                name="project_decription"><?php echo $projectDescription; ?></textarea>
                        </div>
                        <div class="col-md-4 mt-2">
                            <label class="form-label">Total Task</label>
                            <input type="text" class="form-control" name="total_task"
                                value="<?php echo $totalTasks; ?>">
                        </div>
                        <div class="col-md-4 mt-2">
                            ...
                            <select class="form-control js-example-basic-multiple" name="participants[]"
                                ...
                                foreach ($resultemparray['data'] as $emp) {
                                    ...
                                    ?>
                                    <option value="<?php echo $emp['employeeId']; ?>" <?php
                                       if (isset($_GET['id'])) {
